...
{	
	...
	public class ProjectileGravity : MMPoolableObject 
	{
		[Header("Movement")]
        ...
        // determines gravity that affect the projectile
        ...
        protected Vector3 _movementGravity;
	    ...
	    {
            // Vector3 DirectionGravity = (Direction - Vector3.up * Gravity).normalized;
            Vector3 DirectionGravity = Direction;
            _movement = DirectionGravity * (Speed / 10) * Time.deltaTime;
            //_movementGravity = _movement;
            //_movementGravity.y = _movementGravity.y * Gravity;
			transform.Translate(_movement, Space.World);
            //Debug.Log("Direction:" + Direction.ToString("F4"));
            //Debug.Log("Direction Gravity:" + DirectionGravity.ToString("F4"));
            //Debug.Log("Original movement:" + _movement.ToString("F4"));
            //Debug.Log("Gravity movement:" + _movementGravity * 10f);
            // We apply the acceleration to increase the speed
            Speed += Acceleration * Time.deltaTime;
            // We apply the new DirectionGravity to Direction
